...
%  \oldindex{#1}%                    % do the normal index entry
%  %  \marginpar[〈left〉]{〈right〉}:
%  %    • 〈left〉 on even pages  ⇒ left margin (outer)
%  %    • 〈right〉 on odd  pages  ⇒ right margin (outer)
...
\title{	\normalsize \textsc{Research Records} 	% Subtitle
		 	\\[3.0cm]								% 2cm spacing
			\HRule{0.5pt} \\						% Upper rule
			\huge {\sffamily The Manuscript Compendium}% Title
...
\makeatother
%------------------------------------------------------------------------------------%
%DATA ON PAGES% Currently removed for clarity. 
...
Within the authoritative sources on the modern deep learning theory, like \cite{neyshabur2015norm,neyshabur2017exploring,jacot2018ntk,arora2019finegrained,lee2019wide,chizat2019lazy,zou2019implicit,bartlett2021deep,roberts2022principles,wei2022theory,yang2019scaling} in comparison, the new theory of modern networks, or deep learning, remains a very troublesome regime with a lot of unspecified behaviours or outcomes leading on its structures. Unsolved problems emerged from the structural usage, for example, double descent, grokking, neural scaling limits, etc, all of which hinders and expose the immaturity of the concurrent theory. As such, a direction to take on to resolve such issue must be contained, in an effective way nonetheless. 
...
\subsection{The do-calculus and causality modelling}
Specifically, of the causal chain specified in the model~\ref{diag:encoding_structure}, we deliberately imply that there should be certain configuration of the encoding from the morphism $\mathcal{D}_{m}\to \mathcal{A}$. This analysis indeed, exists in nature, and in particular of such, examples can be drawn out of the concept of the \textbf{do-calculus} (\cite{tucci2013introductionjudeapearlsdocalculus}), and in further sense, the construction and consideration of \textbf{causal model} in this setting. 

...
\begin{enumerate}[leftmargin=2cm,topsep=0pt]
  \item[Information] This is the entry for the paper \textbf{Neural Network Design}, in which we formalize and structuralize the neural network architecture in a more general form, and introduce new concepts altogether, strengthening the structural analysis of neural network and its principle, as well as exploring the connection of connectionism analytics, and mathematical modelling. 
\end{enumerate}
